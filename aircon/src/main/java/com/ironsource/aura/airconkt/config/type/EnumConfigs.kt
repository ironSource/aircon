...
fun <T : Enum<T>> intEnumConfig(enumClass: KClass<T>, block: Config<Int, T> .() -> Unit): Config<Int, T> {
...
fun <T : Enum<T>> stringEnumConfig(enumClass: KClass<T>, block: Config<String, T> .() -> Unit): Config<String, T> {
