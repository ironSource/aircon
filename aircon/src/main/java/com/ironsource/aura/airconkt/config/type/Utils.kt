...
internal fun <T : Enum<T>> getIntEnumConst(enumClass: KClass<T>, remoteValue: Int) =
...
internal fun <T : Enum<T>> getStringEnumRemoteValue(enumClass: KClass<T>, enumConstant: T) =
